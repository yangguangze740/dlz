...
--
-- Host: localhost    Database: mvc_boot
-- ------------------------------------------------------
...
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler','DESKTOP-G7HA8HD1550200856143',1550200905899,15000);
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user_online` VALUES ('6c6ba837-4166-4609-9a27-86dcd46621d7','admin','研发部门','127.0.0.1','内网IP','Chrome','Windows 10','on_line','2019-02-15 09:47:37','2019-02-15 11:21:23',1800000);
...
-- Dump completed on 2019-02-15 11:22:42
